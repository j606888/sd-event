...
export function Header({ onMenuClick, team }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-14 items-center border-b border-gray-200 bg-white px-2">
      <button
        type="button"
        onClick={onMenuClick}
        className="flex size-10 shrink-0 items-center justify-center text-gray-600 hover:text-gray-900"
        aria-label="開啟選單"
      >
